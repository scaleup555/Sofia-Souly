#!/usr/bin/env python3
"""Build the final .docx for Tome 6 — La Comète qui n'était pas au rendez-vous."""
...
OUTPUT = BASE / "Sofia-et-Souly-Tome-6-La-Comete-qui-netait-pas-au-rendez-vous.docx"

TITLE = "La Comète qui n'était pas au rendez-vous"
SUBTITLE = "Une aventure en astronomie amateur"
TOME_LABEL = "Tome 6"
JURY_SCORE = "9,1 / 10"
...
def build():
    ...
    add_centered(document, "historiques et scientifiques réels mentionnés dans le récit.", 9.5)
    add_blank(document, 1)
    add_centered(
        document,
