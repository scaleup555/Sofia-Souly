#!/usr/bin/env python3
"""Build the final .docx for Tome 3 — L'Océan qui avait de la fièvre."""
...
OUTPUT = BASE / "Sofia-et-Souly-Tome-3-L-Ocean-qui-avait-de-la-fievre.docx"

TITLE = "L'Océan qui avait de la fièvre"
SUBTITLE = "Une aventure en biologie marine"
TOME_LABEL = "Tome 3"
JURY_SCORE = "8,3 / 10"
...
def build():
    ...
    add_centered(
        document,
        "Édition numérique — manuscrit relu par un jury indépendant",
        9.5,
    )
    add_centered(document, f"de littérature jeunesse (dernière note : {JURY_SCORE}).", 9.5)
